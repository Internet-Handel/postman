...
1. U každého balíku se podívá na detaily problému a pokusí se ho vyřešit.
1. Hotovo. 
...
* Poškozený balík:
    * Pracovník zkusí kontaktovat zákazníka a domluví další postup.
* Jiná chyba
    * Pracovník podpory se může spojit s dispečerem nebo zákazníkem.
...
## <a name="UC-66"></a>UC-66 - Rozdělení jednoho balíku na víc

Předpoklady:

* Pracovník podpory má zobrazený [detail balíku S-05](../screens/#S-05), který bude rozdělen do více balíků.

Kroky:

1. Pracovník klikne na tlačítko rozdělit.
1. Systém vytvoří nový balík, v historii o tom vznikne záznam s odkazem na nový balík.
1. Nový balík nebude mít interní štítek, kód balíku ani rozměry. Stejně tak v historii bude jedinný zaznam o tom, že balík byl vytvořen rozdělením z balíku a odkaz na původní balík.
1. Hotovo.

Pracovník může od původního balíku vytvořit více balíků.
