...
1. Pracovník podpory pořídí záznam do poznámek objednávky [UC-58](../uc-50/#UC-58).
1. Hotovo

Pokud bude existovat jeden nebo více balíků, které nejsou v nějakém koncovém stavu, pak se po stisknutí tlačítka "Storno objednávky" zobrazí jejich seznam a stav objednávky zůstane nezměněný.
...
1. O události pořídí záznam do poznámek objednávky [UC-58](../uc-50/#UC-58).
1. Hotovo
...
1. Pracovník u každého záznamu otevře [S-04 detail objednávky](../screens/#S-04) a zkontroluje, jestli jak zaplacená částka odpovídá fakturované:
    2. Pokud jsou s nějakou tolerancí shodné, pak:
        ...
        * Objednávka se přesune do stavu `Doručovaná` a v událostech se objeví, že daný pracovník podpory pořesunul stav objednávky z `Nezaplacená` do `Doručovaná`.
...
1. Pokud uzná za vhodné kontaktuje zákazníka a domluví s ním další postup a výsledek zaznamená do poznámek objednávky.
...
1. V událostech se objeví záznam o přesunu do stavu "Uzavřeno" s uvedenou informací, že balík byl úspěšně doručen.
1. Pokud jsou všechny balíky na objednávce ve stavu "Uzavřeno", pak se objednávka přesune do stavu "Ukončená".
1. Hotovo

## <a name="UC-58"></a>UC-58 - Přidat záznam do poznámek objednávky
Předpoklady:
...
1. Potvrdí tlačítkem "Uložit poznámku" a systém pracovníka vrátí na stránku s detailem objednávky.
1. V poznámkách je nově přidaný záznam. Jako autor je uvedený přihlášený uživatel.
1. Hotovo
...
1. Zobrazí [detail hledané objednávky S-04](../screens/#S-04).
    ...
    * Pokud chtěl zákazník řešit něco na objednávce, pak může pracovník provézt některý z následujících UC:
        * Storno objednávky
        * Reklamace
1. Pracovník přidá záznam do poznámek objednávky
1. Hotovo
